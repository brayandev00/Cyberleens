  ...
  const steps = [
    {
      step: '01',
      icon: Search,
      title: 'Ingresa el Dominio Objetivo',
      description: 'Simplemente ingresa el dominio o URL que deseas analizar. Nuestro sistema soporta dominios únicos, subdominios y direcciones IP.',
      color: 'blue'
    },
    {
      step: '02',
      ...
      description: 'Nuestros algoritmos avanzados realizan reconocimiento completo usando múltiples fuentes de datos y técnicas de escaneo.',
      color: 'cyan'
    },
    {
      step: '03',
      ...
      description: 'Obtén resultados completos incluyendo subdominios, tecnologías, vulnerabilidades y recomendaciones de seguridad.',
      color: 'emerald'
    },
    {
      step: '04',
      icon: CheckCircle,
      title: 'Exportar y Monitorear',
      description: 'Exporta reportes detallados en formato PDF y configura monitoreo continuo para evaluación de seguridad permanente.',
      color: 'purple'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="max-w-2xl mx-auto text-lg text-muted-foreground">
            Obtén inteligencia web completa en cuatro pasos simples.
            Nuestra plataforma automatizada maneja la complejidad mientras tú te enfocas en los resultados.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-8 px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-500/5 via-cyan-500/5 to-emerald-500/5 border border-blue-500/10">
            <div className="text-center">
              ...
              <div className="text-xs text-muted-foreground">Tiempo Promedio de Escaneo</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-muted-foreground">Fuentes de Datos</div>
            </div>
            <div className="w-px h-8 bg-border" />
            <div className="text-center">
              ...
              <div className="text-xs text-muted-foreground">Tasa de Precisión</div>
            </div>
          </div>
        </div>
      </div>
