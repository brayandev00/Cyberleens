  ...
  React.useEffect(() => {
    const loadStats = async () => {
      try {
        ...
        setStats({ totalUsers: 1250, totalScans: 28000, uptime: 99.9 });
      }
    };
    loadStats();
  }, []);
        ...
        <div className="text-center space-y-8">
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              Plataforma Avanzada de Reconocimiento Web
            </Badge>
          </div>
          ...
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight">
              <span className="block text-foreground">Descubre Inteligencia</span>
              <span className="block bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
                Web Oculta
              </span>
            </h1>
            <p className="max-w-3xl mx-auto text-lg sm:text-xl text-muted-foreground leading-relaxed">
              Obtén información completa sobre cualquier sitio web con nuestra plataforma de reconocimiento avanzado.
              Desde subdominios hasta análisis de seguridad, obtén el panorama completo en minutos.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Seguridad de nivel empresarial con manejo encriptado de datos'
                },
                {
                  icon: Zap,
                  title: 'Ultra Rápido',
                  description: 'Obtén resultados completos en menos de 60 segundos'
                },
                {
                  icon: Eye,
                  title: 'Análisis Profundo',
                  description: 'Descubre subdominios, tecnologías y vulnerabilidades ocultas'
                }
              ].map((feature, index) => (
                <div 
                  key={index}
          ...
          <div className="pt-12 border-t border-border/50">
            <p className="text-sm text-muted-foreground mb-6">Confiado por profesionales de ciberseguridad</p>
            ...
            <div className="flex items-center justify-center gap-8 text-xs text-muted-foreground mt-2">
              ...
              <span>Escaneos Completados</span>
