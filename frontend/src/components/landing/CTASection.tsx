...
const CTASection = () => {
  ...
  const benefits = [
    'Empieza a escanear en menos de 30 segundos',
    'No requiere tarjeta de crédito',
    'Acceso a todas las funciones principales',
    'Exporta reportes PDF detallados',
  ];
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20">
            ...
            <span className="text-sm font-medium text-blue-600 dark:text-blue-400">
              Únete a +100 Profesionales de Seguridad
            </span>
          </div>
        </div>
        ...
        <div className="space-y-6 mb-12">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight">
            <span className="block text-foreground">¿Listo para Descubrir</span>
            <span className="block bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
              Inteligencia Oculta?
            </span>
          </h2>
          <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            Inicia tu primer escaneo de reconocimiento web hoy mismo.
            Descubre lo que otros no pueden ver en solo minutos.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-center gap-8 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              <CheckCircle className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />
              <span>Sin configuración requerida</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />
          ...
          <div className="text-xs text-muted-foreground">
            Confiado por equipos de ciberseguridad
          </div>
        </div>
