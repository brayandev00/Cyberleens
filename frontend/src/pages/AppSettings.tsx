...
const AppSettings = () => {
  ...
  const [userPreferences, setUserPreferences] = useState<ExtendedSettings>({
    ...
    exportFormat: 'json',
    retryAttempts: 3,
    userAgent: 'CyberLeens/1.0 (Security Scanner)'
  });
  ...
  useEffect(() => {
    const getCurrentUser = async () => {
      ...
      await loadUserPreferences('local-user');
    };
    getCurrentUser();
  }, []);
    ...
    try {
      ...
      if (data) {
        setUserPreferences(prev => ({
          ...
          exportFormat: data.export_format as 'json' | 'csv' | 'pdf',
  ...
  const handleExportSettings = () => {
    ...
    a.href = url;
    a.download = `cyberleens-settings-${new Date().toISOString().split('T')[0]}.json`;
          ...
          <Card className="group relative overflow-hidden bg-gradient-to-br from-blue-500/5 via-blue-500/10 to-cyan-500/5 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
            ...
            <CardHeader className="relative z-10">
              ...
              <CardDescription className="text-slate-600 dark:text-slate-400 mt-2">
                Customize your CyberLeens experience
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6 relative z-10">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-muted/30 border-border focus:border-primary"
                  placeholder="CyberLeens/1.0 (Security Scanner)"
                />
