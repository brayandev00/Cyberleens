...
const DashboardPage = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full">
      <AppHeader 
        title="Panel CyberLeens" 
        subtitle="Resumen de tus actividades de reconocimiento"
      >
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          <div className="text-center space-y-4 mb-12">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-full border border-blue-500/20 backdrop-blur-sm">
              ...
              <span className="text-lg font-semibold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
                Panel de Inteligencia de Seguridad
              </span>
            </div>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Monitorea tus actividades de reconocimiento, rastrea vulnerabilidades y gestiona escaneos de seguridad desde un centro de mando unificado.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="group relative overflow-hidden bg-gradient-to-br from-blue-500/5 via-blue-500/10 to-cyan-500/5 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
              ...
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
                <CardTitle className="text-sm font-medium text-slate-600 dark:text-slate-300">Total Escaneos</CardTitle>
              ...
              <CardContent className="relative z-10">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1">
                  ...
                  {scans.length > 0 ? 'Total histórico' : 'Sin escaneos aún'}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group relative overflow-hidden bg-gradient-to-br from-emerald-500/5 via-green-500/10 to-emerald-500/5 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
              ...
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
                <CardTitle className="text-sm font-medium text-slate-600 dark:text-slate-300">Completados</CardTitle>
              ...
              <CardContent className="relative z-10">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1">
                  ...
                  {scans.length > 0 ? `${Math.round((scans.filter(s => s.status === 'completed').length / scans.length) * 100)}% tasa de éxito` : 'Sin datos aún'}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group relative overflow-hidden bg-gradient-to-br from-amber-500/5 via-yellow-500/10 to-orange-500/5 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
              ...
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
                <CardTitle className="text-sm font-medium text-slate-600 dark:text-slate-300">Escaneos Activos</CardTitle>
              ...
              <CardContent className="relative z-10">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1">
                  ...
                  {scans.filter(s => s.status === 'running').length > 0 ? 'Escaneando actualmente' : 'Listo para escanear'}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group relative overflow-hidden bg-gradient-to-br from-rose-500/5 via-red-500/10 to-pink-500/5 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
              ...
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
                <CardTitle className="text-sm font-medium text-slate-600 dark:text-slate-300">Escaneos Fallidos</CardTitle>
              ...
              <CardContent className="relative z-10">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1">
                  ...
                  {scans.filter(s => s.status === 'failed').length > 0 ? 'Requiere atención' : 'Todos los sistemas en orden'}
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Acciones Rápidas</h2>
              ...
              <Link to="/new-scan" className="group">
                <Card className="relative overflow-hidden bg-gradient-to-br from-violet-500/5 via-purple-500/10 to-indigo-500/5 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 cursor-pointer">
                  ...
                  <CardHeader className="text-center pb-6 pt-8 relative z-10">
                    ...
                    <CardTitle className="text-xl font-bold text-violet-700 dark:text-violet-300 mt-4">Escaneo Rápido</CardTitle>
                    <CardDescription className="text-slate-600 dark:text-slate-400 mt-2">
                      Lanza un escaneo inteligente de reconocimiento con gestión adaptativa de payloads
                    </CardDescription>
                  </CardHeader>
                </Card>
              </Link>
              ...
              <Link to="/all-scans" className="group">
                <Card className="relative overflow-hidden bg-gradient-to-br from-teal-500/5 via-cyan-500/10 to-blue-500/5 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 cursor-pointer">
                  ...
                  <CardHeader className="text-center pb-6 pt-8 relative z-10">
                    ...
                    <CardTitle className="text-xl font-bold text-teal-700 dark:text-teal-300 mt-4">Historial de Escaneos</CardTitle>
                    <CardDescription className="text-slate-600 dark:text-slate-400 mt-2">
                      Mira, administra y analiza tus actividades de reconocimiento de seguridad
                    </CardDescription>
                  </CardHeader>
                </Card>
              </Link>
              ...
              <Link to="/reports" className="group">
                <Card className="relative overflow-hidden bg-gradient-to-br from-amber-500/5 via-yellow-500/10 to-orange-500/5 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 cursor-pointer">
                  ...
                  <CardHeader className="text-center pb-6 pt-8 relative z-10">
                    ...
                    <CardTitle className="text-xl font-bold text-amber-700 dark:text-amber-300 mt-4">Reportes</CardTitle>
                    <CardDescription className="text-slate-600 dark:text-slate-400 mt-2">
                      Genera informes completos de seguridad y exporta hallazgos
                    </CardDescription>
                  </CardHeader>
                </Card>
              </Link>
          ...
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-foreground">Configuración y Preferencias</h2>
            <UserConfigPanel />
          </div>

          {/* System Status & API Keys */}
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-foreground">Estado del Sistema</h2>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Escaneos Programados</h2>
              <div className="h-px flex-1 bg-gradient-to-r from-transparent via-slate-200 to-transparent dark:via-slate-700 ml-6" />
            </div>
            <Card className="group relative overflow-hidden bg-gradient-to-br from-purple-500/5 via-violet-500/10 to-indigo-500/5 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
              ...
              <CardHeader className="relative z-10">
                <CardTitle className="flex items-center gap-3 text-slate-900 dark:text-slate-100">
                  ...
                  <span className="font-semibold">Tus Escaneos Programados</span>
                </CardTitle>
                <CardDescription className="text-slate-600 dark:text-slate-400 mt-2">
                  Tareas de reconocimiento automatizado
                </CardDescription>
              </CardHeader>
              <CardContent className="relative z-10">
                <div className="space-y-3">
                  {scheduledScans.length > 0 ? (
                      ...
                      <div key={scan.id} className="flex items-center justify-between p-4 bg-muted rounded-lg border border-border">
                        <div className="flex-1 space-y-1">
                          ...
                          <div className="flex items-center gap-2 text-xs text-muted-foreground">
                            ...
                            <span>Frecuencia: {getFrequencyLabel(scan.schedule.frequency)}</span>
                            {scan.status === 'active' && scan.schedule.nextRun && (
                              <>
                                <span className="text-border">•</span>
                                <ClockIcon className="h-3 w-3" />
                                <span>Próximo Run: {format(new Date(scan.schedule.nextRun), 'MMM dd, yyyy HH:mm')}</span>
                              </>
                            )}
                          </div>
                        </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-12 text-center">
                      ...
                      <p className="text-slate-600 dark:text-slate-400 font-medium">Sin escaneos programados aún</p>
                      <p className="text-sm text-slate-500 dark:text-slate-500 mt-1">Crea uno en "Nuevo Escaneo" para automatizar tu reconocimiento</p>
                    </div>
                  )}
                </div>
              </CardContent>
